...
className={`px-2 py-1.5 font-mono font-normal whitespace-nowrap cursor-pointer select-none ${c.align === "center" ? "text-center" : c.align === "right" ? "text-right" : "text-left"} transition-colors hover:opacity-100 ${active ? `${activeColor} opacity-100`:`${baseColor} opacity-70 hover:opacity-90`}`}
>
{c.label}
